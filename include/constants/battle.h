...
#define BATTLE_CIRCUS_COSMIC_TERRAIN		0x82000000
...
#define BATTLE_CIRCUS_TERRAIN (BATTLE_CIRCUS_ELECTRIC_TERRAIN | BATTLE_CIRCUS_GRASSY_TERRAIN | BATTLE_CIRCUS_MISTY_TERRAIN | BATTLE_CIRCUS_PSYCHIC_TERRAIN | BATTLE_CIRCUS_COSMIC_TERRAIN)
